...
<body>
    ...
    <main class="board ">
        ...
        <section class="comments">
            <?php 
            $comment_sql = "SELECT u.id as user_id, c.id as id, c.content, c.created_at as time, u.nickname as nickname FROM Lauviah_board_comments as c LEFT JOIN Lauviah_board_users as u ON c.user_id = u.id WHERE c.is_deleted = 0";
